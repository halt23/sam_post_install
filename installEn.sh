...
# Sam's post install script
# by Sam Maas <sam@sammaas.com>
# licensed under: GNU GPLv3
# this script was based and in some way is, based on LARBS BY Luke Smith.
# some of the initial credits go tho him but, but I changed alot and my script isn't connected to Luke Smith in any legal way.
